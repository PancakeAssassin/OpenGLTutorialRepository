...
bool Init()
{
	...
	//create the window
	Window = glfwCreateWindow(SCREEN_WIDTH, SCREEN_HEIGHT, "OpenGL Tutorial 1.1", NULL, NULL);
	if (!Window)
	{
		glfwTerminate();
		return false;
...
void DrawScene()
{
	...
	glVertexAttribPointer(VertexPosition, 2, GL_FLOAT, GL_FALSE, 5 * sizeof(GLfloat), 0);
	glEnableVertexAttribArray(VertexColor);
	glVertexAttribPointer(VertexColor, 3, GL_FLOAT, GL_FALSE, 5 * sizeof(GLfloat), (void*)(2 * sizeof(GLfloat)));
