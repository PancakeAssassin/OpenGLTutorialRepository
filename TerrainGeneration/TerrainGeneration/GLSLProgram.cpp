...
void GLSLProgram::compileShader(const string& source, GLSLShader::GLSLShaderType type, const char* fileName) throw (GLSLProgramException)
{
	if(handle <=0)
	{
		handle= glCreateProgram();
...
void GLSLProgram::printActiveUniforms()
{
	...
	for(int i= 0; i <numUniforms; ++i)
	{
		...
		glGetProgramResourceName(handle, GL_UNIFORM, i ,nameBuffSize, NULL, name);
