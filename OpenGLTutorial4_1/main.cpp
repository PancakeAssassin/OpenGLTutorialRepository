...
void DrawScene()
{
	...
	Program->SetUniform("Light.La", AmbientLightIntensity);
	Program->SetUniform("Material.Ka", AmbientReflectivity);
	Program->SetUniform("Light.Ld", DiffuseLightIntensity);
	Program->SetUniform("Material.Kd", DiffuseReflectivity);
	Program->SetUniform("Light.Ls", SpecularLightIntensity);
	Program->SetUniform("Material.Ks", SpecularReflectivity);
